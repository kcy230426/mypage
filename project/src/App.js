...
import dbadsh from './db/tadsh.json'
  ...
  return (
    <HashRouter>
          ...
          <Routes>
            ...
            <Route path='/template' element={<Template dbtads={data.db} dbgal1={dbads.tads} dbgal2={dbmenu.tmenu} dbgal3={dbadsh.tadsh}></Template>}></Route>
